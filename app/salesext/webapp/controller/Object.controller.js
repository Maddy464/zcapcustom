...
sap.ui.define([
	...
	"salesext/model/formatter"
], function (BaseController, JSONModel, History, formatter) {
	"use strict";

	return BaseController.extend("salesext.controller.Object", {
		...
		_onObjectMatched: function (oEvent) {
			...
			//this.getModel().metadataLoaded().then(function () {
				...
				// var sObjectPath = this.getOwnerComponent().getModel().createKey("SalesOrder_ext", {
		...
		_onBindingChange: function () {
			...
			this.addHistoryEntry({
				...
				intent: "#SalesOrderCockpit-display&/SalesOrder_ext/" + sObjectId
			});
